    ...
    <div
        ...
        <div class="tw-w-full md:tw-w-1/3">
            <div class="tw-flex tw-items-center tw-gap-2">
                <p><strong>@lang('sale.location'): &nbsp;
                <input class="input-icheck can_sale_multiple_location_product" id="can_sale_multiple_location_product" name="can_sale_multiple_location_product" type="checkbox" style="position: absolute; opacity: 0;">
