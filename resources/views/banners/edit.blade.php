...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('business.edit_banner')</h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
    {!! Form::open([
        ...
        'method' => 'PUT', // Use 'PATCH' if your route is defined for PATCH
        'id' => 'edit_banner_form',
        'class' => 'category_form',
        'files' => true
    ]) !!}    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            {!! Form::text('cta_text', old('cta_text', $banner->cta_text), ['class' => 'form-control ' . ($errors->has('cta_text') ? 'is-invalid' : ''), 'placeholder' => __('business.business_cta_text')]); !!}
                            @error('cta_text')
                                <span class="error text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            {!! Form::label('cta_link', __('business.cta_link')) !!}
                            {!! Form::text('cta', old('cta', $banner->cta), ['class' => 'form-control ' . ($errors->has('cta') ? 'is-invalid' : ''), 'placeholder' => __('business.business_cta')]); !!}
                            @error('cta')
                                <span class="error text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            {{-- <img id="image-preview" style="height: 150px; margin-top: 10px;" src="{{ asset($banner->image) }}" alt="Image Preview" style="max-width: 100%; margin-top: 10px;"> --}}
                            @error('image')
                                <span class="error text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            {!! Form::select(
                                'is_active', 
                                ['1' => 'Active', '0' => 'Inactive'], 
                                old('is_active', isset($banner->is_active) ? $banner->is_active : '0'), 
                                [
                                    'class' => 'form-control ' . ($errors->has('is_active') ? 'is-invalid' : ''), 
                                    'placeholder' => __('business.status')
                                ]
                            ) !!}
                            @error('is_active')
                                <span class="error text-danger" role="alert">
