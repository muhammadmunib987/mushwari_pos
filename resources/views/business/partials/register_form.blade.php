...
@if(empty($is_admin))
    ...
    <div class="col-sm-6">
        <div class="form-group">
            {!! Form::label('enable_fbr_taxpayer_system', __('business.enable_fbr_taxpayer_system') . ':*') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-info"></i>
                </span>
                {!! Form::select('enable_fbr_taxpayer', ['1' => 'Yes', '0' => 'No'], 0, ['class' => 'form-control select2_register fbr_taxpayer_check', 'required', 'style' => 'width:100%;', 'onchange' => 'showFields();']); !!}
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="fbr_details" style="display: none;">
        <div class="col-md-6">
            <div class="form-group">
                {!! Form::label('pos_id_label',__('business.pos_id') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-suitcase"></i>
                    </span>
                    {!! Form::text('pos_id', null, ['class' => 'form-control','placeholder' => __('business.pos_id_placeholder')]); !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                {!! Form::label('pos_token_label',__('business.pos_token') . ':') !!}
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="fa fa-lock"></i>
                    </span>
                    {!! Form::text('pos_token', null, ['class' => 'form-control','placeholder' => __('business.pos_token_placeholder')]); !!}
                </div>
            </div>
        </div>
    </div>
