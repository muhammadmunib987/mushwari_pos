...
@section('content')
    ...
    @endphp
    <div class="row" style="background-image: url('https://business.jadidkhata.com/img/bg_img.jpeg') !important;
            ...
            <div
                ...
                <div class="tw-flex tw-flex-col tw-gap-4 tw-dw-rounded-box tw-dw-p-6 tw-dw-max-w-md">
                    ...
                    <div class="tw-flex tw-items-center tw-flex-col">
                        ...
                        <a target="_blank" style="text-align: center;" href="https://pos.jadidkhata.com/login"
                            class="tw-text-lg tw-text-gray-700 hover:tw-text-gray-400 tw-mt-4 tw-block tw-py-2 tw-px-4 tw-border tw-border-gray-300 tw-rounded-lg tw-shadow-lg tw-bg-white tw-transition tw-transform hover:tw-scale-105 hover:tw-shadow-2xl">
                                Old customer click here for login
                                <span class="tw-text-lg tw-bg-gradient-to-r tw-from-indigo-500 tw-to-blue-500 tw-inline-block tw-text-transparent tw-bg-clip-text hover:tw-text-[#467BF5] hover:tw-underline">
                                    Click Here
                                </span>
                            </a>
                    ...
                    <p style="text-align: center;"><b><span style="color: red;">Note :</span> Jadid Khata Launches Exciting New Updates - Old Customers can Get  Free Account Now</b> </p>
