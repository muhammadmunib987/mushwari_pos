  ...
  <div class="col-sm-12">
    ...
    <table class="table table-condensed">
      ...
      <tr>
        ...
        <td>
          <span class="display_currency" data-currency_symbol="true">{{ $register_details->sale_refund }}</span>
        </td>
      </tr>
      <tr class="danger">
        <th>
        ...
        <td>
          ...
          @if($register_details->total_card_refund != 0) 
            Card: <span class="display_currency" data-currency_symbol="true">{{ $register_details-success>total_card_refund }}</span><br> 
          @endif
      ...
      <tr class="success">
        ...
        <td class="total_payment">
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand + $register_details->total_cash - $register_details->total_cash_refund - $register_details->sale_refund }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
