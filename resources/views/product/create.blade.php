...
<section class="content">
    ...
    <div class="row">
        ...
        <input class="form-control" placeholder="Product Name" name="product_sku[]" type="hidden" id="product_sku" aria-required="true" fdprocessedid="eyj1m8">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <button type="button" @if(!auth()->user()->can('unit.create')) disabled @endif class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action([\App\Http\Controllers\UnitController::class, 'createSubunit'], ['quick_add' => true])}}" title="Add Sub Unit" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
                    </span>
                </div>
            </div>
        </div>
