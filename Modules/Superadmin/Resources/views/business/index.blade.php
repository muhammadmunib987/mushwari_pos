...
@section('javascript')
        ...
        $(document).ready(function() {
            superadmin_business_table = $('#superadmin_business_table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'enable_fbr_taxpayer',
                        name: 'enable_fbr_taxpayer',
                    },
                    {
    ...
    $(document).on('change', '.fbr_tax_check', function(e){
        var id = $(this).attr("id");
        $.ajax({
            type:'post',
            url: "{{route('business.update_fbr_taxpayer_status')}}",
            data: {id: id},
