    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($query)
                ...
                ->addColumn( 'enable_fbr_taxpayer', '@if($pos_id && $pos_token)<label class="switch"><input type="checkbox" {{$enable_fbr_taxpayer == 1 ? "checked" : ""}} class="fbr_tax_check" id="{{$id}}"><span class="slider round"></span></label>@else <span class="label bg-gray">POS ID, Token Not Added</span> @endif')
                ...
                ->rawColumns(['action', 'is_active', 'created_at', 'enable_fbr_taxpayer'])
                ->make(true);
        }
