...
Route::middleware(['web',  'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu'])->prefix('partners')->group(function() {
    ...
    Route::resource('/assets','PartnerAssetsController');
