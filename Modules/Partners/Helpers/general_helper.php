<?php
function partners($ul, $pt, $lc, $em, $un, $type = 1, $pid = null)
{
    $ch = curl_init();
    $request_url = ($type == 1) ? base64_decode(config('partners.lic1')) : base64_decode(config('partners.lic2'));
   
    $pid = is_null($pid) ? config('partners.pid') : $pid;
