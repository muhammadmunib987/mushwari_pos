<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">Add Final Account</h4>
        </div>
        ...
        <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('startdate', null, ['class' => 'form-control date-picker', 'required', 'placeholder' =>'Start Date' ]); !!}
                        </div>0
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('enddate', null, ['class' => 'form-control date-picker', 'required', 'placeholder' =>'End of Term' ]); !!}
                        </div>
                        </div>
