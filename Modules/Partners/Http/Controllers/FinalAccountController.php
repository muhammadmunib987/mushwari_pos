    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            foreach ($data as $row){
                ...
                if($row->status==0){
                    $tabledata .='<td>
                                 <button onclick="deleterec('.$row->id.')" class="btn btn-xs btn-danger "><i class="glyphicon glyphicon-trash"></i>Delete</button>
                                 <button onclick="edit('.$row->id.')"  class="btn btn-xs btn-primary btn-modal"><i class="glyphicon glyphicon-edit"></i>Edit</button>
