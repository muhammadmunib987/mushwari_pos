    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $datatable = Datatables::of($sells)
                ...
                ->editColumn(
                    'fbr_invoice_no',
                    '<span class="fbr-invoice-no" data-orig-value="{{$fbr_invoice_no}}">@if(empty($fbr_invoice_no))<span class="label bg-aqua">Tax Not Paid</span> @else {{$fbr_invoice_no}}@endif</span>'
                )
            ...
            $rawColumns = ['final_total', 'action', 'total_paid','fbr_invoice_no', 'total_remaining', 'payment_status', 'invoice_no', 'discount_amount', 'tax_amount', 'total_before_tax', 'shipping_status', 'types_of_service_name', 'payment_methods', 'return_due', 'conatct_name', 'status'];
