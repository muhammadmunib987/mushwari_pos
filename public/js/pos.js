    ...
    if (item_addtn_method == 0) {
        ...
        $('#pos_table tbody')
            ...
            .each(function() {
                ...
                var product_new_row=$('.product_new_row').is(':checked');
            
                if (!product_new_row && (row_v_id == variation_id && enable_sr_no !== '1' && !modifiers_exist && !is_added)) {
                    add_via_ajax = false;
                    is_added = true;
...
function reset_pos_form(){
    ...
    var can_sale_multiple_location_product=$('.can_sale_multiple_location_product').is(':checked');
    if(!can_sale_multiple_location_product){
